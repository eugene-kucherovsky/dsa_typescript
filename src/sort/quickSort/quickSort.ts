...
// Time complexity: O(n2) - by worst scenario when array is unsorted, unstable
// in average scenario O(n log n)
...
function quickSortWithRandomPivot(arr: any[]): any[] {
  if (arr.length < 2) {
    return arr;
  }
  let min = 1;
...
export { quickSort, quickSortWithRandomPivot};
